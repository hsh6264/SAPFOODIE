		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#b02sdcommonsdorder1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"b02sdcommonsdorder1-display": {
								"semanticObject": "b02sdcommonsdorder1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=b02.sd.common.sdorder1",
									"url": sap.ui.require.toUrl("b02/sd/common/sdorder1")
								}
							}
						}
					}
